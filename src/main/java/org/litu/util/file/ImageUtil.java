...
import org.litu.util.net.SocketUtil;
...
public class ImageUtil {
    ...
    public static void main(String[] args) {
        // 1-缩放图像：
        // 方法一：按比例缩放
        ImageUtil.scale("D:\\photo\\1111\\1.png", "D:\\photo\\1111\\2.png", 2, true);// 测试OK
        // 方法二：按高度和宽度缩放
        ImageUtil.scale2("D:\\photo\\1111\\1.png", "D:\\photo\\1111\\2.png", 500, 300, true);// 测试OK

        // 2-切割图像：
        // 方法一：按指定起点坐标和宽高切割
        ImageUtil.cut("D:\\photo\\1111\\1.png", "D:\\photo\\1111\\2.png", 0, 0, 400, 400);// 测试OK
        // 方法二：指定切片的行数和列数
        ImageUtil.cut2("D:\\photo\\1111\\1.png", "D:\\photo\\1111\\2.png", 2, 2);// 测试OK
        // 方法三：指定切片的宽度和高度
        ...
        // 5-给图片添加文字水印：
        // 方法一：
        ImageUtil.pressText("我是水印文字", "e:/abc.jpg", "e:/abc_pressText.jpg", "宋体", Font.BOLD, Color.white, 80, 0, 0,
                0.5f);// 测试OK
        // 方法二：
