...
*/
(function(e) {
    "object" === typeof module && module.exports ? (e["default"] = e, module.exports = e) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"],
    function(m) {
        e(m);
        e.Highcharts = m;
        return e
    ...
    e = e ? e._modules: {};
    m(e, "modules/full-screen.src.js", [e["parts/Globals.js"]],
    function(f) {
        var g = f.addEvent,
        e = f.Chart,
        n = function() {
            ...
            g.prototype.open = function() {
                ...
                g = h.chart;
                if (h.browserProps) {
                    h.unbindFullscreenEvent = f.addEvent(g.container.ownerDocument, h.browserProps.fullscreenChange,
                    function() {
            ...
            g.prototype.setButtonText = function() {
                ...
                h = g.options.lang; (null === e || void 0 === e ? 0 : e.menuItemDefinitions) && (null === h || void 0 === h ? 0 : h.exitFullscreen) && h.viewFullscreen && n && f && f.length && (f[n.indexOf("viewFullscreen")].innerHTML = this.isOpen ? h.exitFullscreen: e.menuItemDefinitions.viewFullscreen.text || h.viewFullscreen)
            };
    ...
    m(e, "modules/exporting.src.js", [e["parts/Globals.js"], e["parts/Utilities.js"], e["mixins/navigation.js"]],
    function(f, g, e) {
        var n = g.addEvent,
        u = g.css,
        h = g.createElement,
        ...
        x(C.prototype, {
            ...
            moveContainers: function(a) { (this.fixedDiv ? [this.fixedDiv, this.scrollingContainer] : [this.container]).forEach(function(b) {
                    a.appendChild(b)
                })
            },
            beforePrint: function() {
                ...
                B(this, "beforePrint");
                b && this.chartWidth > b && (c.resetParams = [this.options.chart.width, void 0, !1], this.setSize(b, void 0, !1)); [].forEach.call(c.childNodes,
                function(a, b) {
            ...
            afterPrint: function() {
                if (this.printReverseInfo) {
                    ...
                    this.moveContainers(this.renderTo); [].forEach.call(a,
                    function(a, c) {
            ...
            contextMenu: function(a, b, c, d, e, f, r) {
                ...
                if (!l) {
                    ...
                    k.exportEvents.push(n(l, "mouseleave",
                    function() {
                    ...
                    b.forEach(function(a) {
                        ...
                        if (J(a, !0)) {
                            if (a.separator) var b = h("hr", null, null, m);
                            else b = h("li", {
                            ...
                            null, m),
                            k.styledMode || (b.onmouseover = function() {
    ...
    m(e, "masters/modules/exporting.src.js", [],
    function() {})
});
