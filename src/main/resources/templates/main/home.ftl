...
<head>
    ...
    <link href="${rc.contextPath}/static/appcore/bootstrap/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="${rc.contextPath}/static/css/font-awesome.css?v=4.4.0" rel="stylesheet">

    <!-- Morris -->
    <link href="${rc.contextPath}/static/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <link href="${rc.contextPath}/static/css/animate.css" rel="stylesheet">
    <link href="${rc.contextPath}/static/appcore/hplus/style.css?v=4.1.0" rel="stylesheet">
</head>
<body class="gray-bg">
...
<!-- 全局js -->
<script src="${rc.contextPath}/static/js/jquery/jquery.min.js?v=2.1.4"></script>
<script src="${rc.contextPath}/static/appcore/bootstrap/bootstrap.min.js?v=3.3.6"></script>

<!-- Flot -->
<script src="${rc.contextPath}/static/js/plugins/flot/jquery.flot.js"></script>
<script src="${rc.contextPath}/static/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="${rc.contextPath}/static/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="${rc.contextPath}/static/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="${rc.contextPath}/static/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="${rc.contextPath}/static/js/plugins/flot/jquery.flot.symbol.js"></script>

<!-- 自定义js -->
<script src="${rc.contextPath}/static/js/lt.content.js?v=1.0.0"></script>

<!-- Jvectormap -->
<script src="${rc.contextPath}/static/js/jquery/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${rc.contextPath}/static/js/jquery/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- EayPIE -->
<script src="${rc.contextPath}/static/js/jquery/jquery.easypiechart.js"></script>

<!-- Sparkline -->
<script src="${rc.contextPath}/static/js/jquery/jquery.sparkline.min.js"></script>
